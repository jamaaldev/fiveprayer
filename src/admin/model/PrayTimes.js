	...
	*/
	...
	return {
		...
		getTimes: function ( date, coords, timezone, dst, format ) {
			...
			jDate =
				this.julian( date[ 0 ], date[ 1 ], date[ 2 ] ) -
				lng / ( 15 * 24 );
		...
		sunPosition: function ( jd ) {
			...
			var R =
				1.00014 -
				0.01671 * DMath.cos( g ) -
				0.00014 * DMath.cos( 2 * g );
			var e = 23.439 - 0.00000036 * D;

			var RA =
				DMath.arctan2(
					DMath.cos( e ) * DMath.sin( L ),
					DMath.cos( L )
				) / 15;
		...
		computeTimes: function () {
			...
			times.midnight =
				setting.midnight == 'Jafari'
					? times.sunset +
					  this.timeDiff( times.sunset, times.fajr ) / 2
					: times.sunset +
