...
import PrinterPageCustomizing from './printerpage/PrinterPageCustomizing';

export interface ICustomizingContentRoutesProps {}

export function CustomizingContentRoutes(
	props: ICustomizingContentRoutesProps
) {
	return (
		<div>
			<Routes>
				<Route
					path="customizingdesign/*"
					element={ <CustomizingDesign /> }
				/>
				<Route path="timetable" element={ <TimeTableMonthly /> } />
				<Route
					path="printerpage"
					element={ <PrinterPageCustomizing /> }
				/>
			</Routes>
		</div>
	);
