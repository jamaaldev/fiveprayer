				...
				<thead>
					...
					<tr>
						<td colSpan={ 3 }>
							...
							<div
								className="fiveprayer__iqamah_next"
								style={ { padding: '10px', color: secondBg } }
							>
								NEXT PRAYER
							</div>
							<div
								className="fiveprayer__iqamah_next"
								style={ { color: secondBg } }
							>
								FAJR IQAMAH
							</div>
							<div
								className="fiveprayer__iqamah_time"
								style={ { padding: '20px', color: secondBg } }
							>
								{ ' ' }
								4:28 AM
							</div>
