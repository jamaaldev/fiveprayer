...
function PrinterPageCustomizing( {}: Props ) {
	...
	const [ printerPage, SetPrinterPage ] = React.useState( {
		...
		printer_boolean:
			FivePrayerPrinter?.printer_boolean.toString() || 'false',
		printer_logo:
			FivePrayerPrinter?.printer_logo || 'https://fakeimg.pl/200x200/',
	} );
	...
	return (
		<div id="Customizing" className="tabcontent">
			...
			<div className="checkbox__container">
				...
				<label className="switch">
					<input
						...
						checked={ JSON.parse( printerPage.printer_boolean ) }
						name="printer_boolean"
						id=""
					/>
			...
			<PrinterContainer
				onSubmit={ savePrinterPage }
				className="FP__input__container"
			>
				<div>
					<h1>Left Side</h1>
					<input
						className="FP__input"
						value={ printerPage?.printer_left1 }
						type="text"
						name="printer_left1"
						onChange={ handleChange }
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_left2 }
						type="text"
						name="printer_left2"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_left3 }
						type="text"
						name="printer_left3"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_left4 }
						type="text"
						name="printer_left4"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_left5 }
						type="text"
						name="printer_left5"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_left6 }
						type="text"
						name="printer_left6"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_left7 }
						type="text"
						name="printer_left7"
						onChange={ handleChange }
						placeholder="Add Details"
				...
				<div className="profile-uploud">
					...
					<input
						...
						onChange={ handleChange }
						name="printer_logo"
						placeholder="Add url link image"
						id=""
					/>
				...
				<div>
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right1 }
						type="text"
						name="printer_right1"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right2 }
						type="text"
						name="printer_right2"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right3 }
						type="text"
						name="printer_right3"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right4 }
						type="text"
						name="printer_right4"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right5 }
						type="text"
						name="printer_right5"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right6 }
						type="text"
						name="printer_right6"
						onChange={ handleChange }
						placeholder="Add Details"
					...
					<input
						className="FP__input"
						value={ printerPage?.printer_right7 }
						type="text"
						name="printer_right7"
						onChange={ handleChange }
						placeholder="Add Details"
