...
export const CustomLocation = () => {
	...
	const { data: locationcity, isFetching } =
		useGetLocationQuery( 'fp_location' );
			...
			<div className="location__col2">
				<div className="FP__input__container">
					...
					<input
						...
						value={ lng }
						onChange={ addLocationHandle }
						placeholder="Add Longitude,Lng"
					/>
					<button
						className="middle_button"
						onClick={ listInsertUpdate }
					>
						Add Location
					</button>
				</div>
